...
execute if score $timbre_success muit.cache1 matches 0 run data modify storage muit:timbre Root.SelectedTimbre set value {"name":"Minecraft Harp","timbre_id":"minecraft:block.note_block.harp"}
