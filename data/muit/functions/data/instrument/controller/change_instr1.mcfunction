function muit:data/instrument/controller/_detect_block with storage muit:cache0 Cache.Instruments[0]
...
execute if score @s muit.cache1 matches 0 if data storage muit:cache0 Cache.Instruments[0] run function muit:data/instrument/controller/change_instr1